...
glslangValidator -V UIFontVertexShader.vert -o UIFontvert.spv
glslangValidator -V postprocess.vert -o postprocessVert.spv



glslangValidator -V fogVolumetric.comp -o fogVolumetricCompute.spv
...
glslangValidator -V UIFontFragmentShader.frag -o UIFontfrag.spv
glslangValidator -V fogPostprocess.frag -o fogPostprocessFrag.spv
glslangValidator -V postprocess.frag -o postprocessFrag.spv
