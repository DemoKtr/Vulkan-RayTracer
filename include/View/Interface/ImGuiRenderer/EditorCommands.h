...
namespace vkImGui {
	...
	void render_editor(vkThumbs::ThumbsManager* miniatureManager, vkImGui::FilesExploresData& filesExploresData, SceneObject* root, SceneObject* &selectedObj, ComponentType& selectedComponentType, ecs::ECS* ecs, fileOperations::filesPaths models, fileOperations::filesPaths textures, vkMesh::MeshesManager* meshesManager);
	void render_console();
	...
	void display_scene_object(SceneObject* &selectedObject, ecs::ECS* ecs, fileOperations::filesPaths models, fileOperations::filesPaths textures, vkMesh::MeshesManager* meshesManager, vkThumbs::ThumbsManager* miniatureManager, ComponentType& selectedComponentType);
